...
class DrinksItemPage extends StatefulWidget {
  const DrinksItemPage({super.key});

  @override
  State<DrinksItemPage> createState() => _DrinksItemPageState();
}

class _DrinksItemPageState extends State<DrinksItemPage> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:StreamBuilder<List<FoodItemModel>>(
        stream: foodController.streamDrinksItems(),
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.isEmpty) {
            return const Center(child: Text("No drinks items found"));
          }
