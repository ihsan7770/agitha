...
class SpecialFoodItems extends StatefulWidget {
  
   SpecialFoodItems({super.key});

  @override
  State<SpecialFoodItems> createState() => _SpecialFoodItemsState();
}

class _SpecialFoodItemsState extends State<SpecialFoodItems> {
  @override
   ...
   final screenWidth = MediaQuery.of(context).size.width;
    ...
    return Scaffold(
      ...
      body:StreamBuilder<List<FoodItemModel>>(
        stream: foodController.streamSpecialFoodItems(),
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.isEmpty) {
            return const Center(child: Text("No special food items found"));
          }
