...
class CakeItemsPage extends StatefulWidget {
  const CakeItemsPage({super.key});

  @override
  State<CakeItemsPage> createState() => _CakeItemsPageState();
}

class _CakeItemsPageState extends State<CakeItemsPage> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:StreamBuilder<List<FoodItemModel>>(
        stream: foodController.streamCakeItems(),
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.isEmpty) {
            return const Center(child: Text("No cake items found"));
          }
