...
class International_GridView extends StatelessWidget {
  const International_GridView({super.key});
  ...
  return StreamBuilder<List<CompanyRegistrationModel>>(
      stream: companyProvider.InternationalBrandStream(),
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return RestaurantCard(
              ...
              describtion: company.description,     // or restaurantImageUrl
            );
          },
        );
      },
