...
class AdminSideUserDetails extends StatelessWidget {
  const AdminSideUserDetails({super.key});
 ...
 final ProfileProvider = Provider.of<UserAdminSideProvider>(context);
    ...
    final provider = Provider.of<UserAdminSideProvider>(context);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            StreamBuilder<List< UserRegistrationModel>>(
                    stream: ProfileProvider.getProfileStream(),
             ...
             leading: CircleAvatar(
              ...
              context,
              listen: false,
                     ).blockUser(profiles.documentid, context);
                   }
                 },
                 style: ElevatedButton.styleFrom(
