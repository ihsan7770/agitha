...
class _FoodPaymentPageState extends State<FoodPaymentPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final double totalAmount =
        cartController.totalPrice + _selectedTip;
      ...
      appBar: AppBar(
        leading: IconButton(
          ...
          backgroundColor:
            ...
            if (confirm == true) {
              final success = await Provider.of<OrderController>(
                context,
                listen: false,
  ...
  onPressed: () {
    final value = int.tryParse(_customTipController.text);
    ...
    style: TextStyle(color: Colors.white),
            ...
            RadioListTile<String>(
              ...
              title:ListTile(
                ...
                subtitle: const Text("Pay using Stripe",style: TextStyle(color: Colors.grey),), 
                leading: Image.asset("assets/payicon/card.png",
                      height: 30), 
              )   
            ...
            RadioListTile<String>(
              ...
              title:ListTile(
                ...
                subtitle: const Text("Cash on Delivery",style: TextStyle(color: Colors.grey),),
                leading:    Image.asset("assets/payicon/cod.png",
                      height: 40), 
              )
