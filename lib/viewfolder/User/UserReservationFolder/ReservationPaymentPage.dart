                ...
                child: Column(
                  ...
                  children: [
                    ...
                    color: const Color.fromARGB(255, 75, 2, 2),
                     ...
                     Text("Type: Casual Reservation",style: GoogleFonts.tinos(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.black
                    )),
                    ...
                    Text("Time: 7:00 PM",style: GoogleFonts.tinos(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.black
                    )),
                    ...
                    color: Colors.black
                     ...
                     Text("Table No: T4P4",style: GoogleFonts.tinos(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.black
                    )),
                    ...
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: Text("Total Amount: ₹2000",style: GoogleFonts.tinos(
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
                        color: Colors.black
                        )),
